...
if (empty($id)) {
    $_SESSION['error'] = "ID de unidad de medida no especificado.";
...
try {
    ...
    if ($stmt->execute()) {
        $_SESSION['success'] = "Unidad de medida eliminada con éxito.";
    } else {
        $_SESSION['error'] = "Error al eliminar la unidad de medida.";
    }
